...
import com.mao.community.dao.LoginTicketMapper;
import com.mao.community.dao.UserMapper;
import com.mao.community.entity.LoginTicket;
...
//        return userMapper.selectById(id);
    ...
    public int activation(int userId, String code) {//激活状态
...
//        return loginTicketMapper.selectByTicket(ticket);
        String redosKey=RedisKeyUtil.getTicketKey(ticket);
        return (LoginTicket) redisTemplate.opsForValue().get(redosKey);
    }
